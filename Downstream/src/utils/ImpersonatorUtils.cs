...
namespace com.bitscopic.downstream.src.utils
{
    [PermissionSet(SecurityAction.Demand, Name = "FullTrust")]
    public class ImpersonatorUtils : IDisposable
    {
        ...
        /// </summary>
        [PermissionSet(SecurityAction.Demand, Name = "FullTrust")]
        public void startImpersonation(String domain, String username, String password)
        {
            ...
            if (LogonUser(username, domain, password, LOGON32_LOGON_INTERACTIVE, LOGON32_PROVIDER_DEFAULT, ref handle))
            {
                ...
                {
                    throw new MdoException("There was an unexpected issue while attempting to run as the specified account");
                }
            }
            int err = System.Runtime.InteropServices.Marshal.GetLastWin32Error();
            System.Console.WriteLine("Error: " + err);
            throw new ApplicationException("Unable to run as the specified account! Invalid credentials?");
        }
